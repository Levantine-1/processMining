...
data "aws_iam_policy_document" "github_actions_assume_role" {
  statement {
    ...
    condition {
      ...
      #   repo:Levantine-1@71067517/processMining@1342417979:ref:refs/heads/master
      # instead of the classic
      #   repo:Levantine-1/processMining:ref:refs/heads/master
      ...
      # only the numeric IDs, anchored after "Levantine-1@" and "/processMining@".
      test     = "StringLike"
